...
class b1990_ReceiptViewDetail extends ViewDetail {

	function b1990_ReceiptViewDetail(){
 		parent::ViewDetail();
 	}
	...
	function populateQuoteTemplates(){
		...
		$sql = "SELECT id, name FROM aos_pdf_templates WHERE deleted=0 AND type='b1990_Receipt' AND active = 1";
